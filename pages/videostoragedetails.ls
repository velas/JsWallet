...
video = (store, web3t)->
    ...
    img =
        ...
        like: 'data:image/png;base64,'
    .pug.panel-content
        .pug.section
            .source.pug
...
comments = (store, web3t)->
    ...
    .pug.comments
        ...
        span.pug.action
            ...
            ul.pug.rating
                li.pug
                    img.like.pug(src="#{img.like}")
                li.pug
                    span.pug 124
                li.pug
                    img.dislike.pug(src="#{img.like}")
                li.pug
                    span.pug 
                li.pug
