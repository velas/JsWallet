...
(function(){
  var Polar, react, map, ethToVlx, getStake, getColor, buildData, legend;
  ...
  module.exports = function(store, web3t){
    var data, width, height, legend;
    if (store.staking.pools.length === 0) {
      return null;
    }
    data = buildData(store.staking.pools);
    return Polar.pug(data = data(width = 100, height = 100, legend = legend));
  };
}).call(this);
