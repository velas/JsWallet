...
(function(){
  ...
  strategy = function(c, n, sass){
    var o, objToPairs, camelize, optimize, replacePart, renderText, renderOptimized, renderSubnode, renderChildren, getVal, renderAttrs, attrs, nextSpace, ref$, ref1$, ref2$, end, element;
    o = parse(sass, c);
  ...
  parseLine = function(t){
    ...
    rest = function(char, next){
      if (char === '.' && (next != null && (typeof next.match == 'function' && next.match(/[a-z]/i)))) {
        ...
        return collector.current = collector.current;
