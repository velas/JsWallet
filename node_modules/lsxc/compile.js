  ...
  compile = function(commander, cb){
    ...
    if (commander.bundle != null) {
      return makeBundle(file, function(err, bundlec){
        var alias, dynamicCSS, dynamicHTML, defaultTemplate, currentTemplate, html, resultHtml;
        if (err != null) {
          return cb2(err);
        }
        if (commander.minify) {
        ...
        alias = (function(){
          switch (false) {
          case commander.alias == null:
            return "?alias=" + commander.alias;
          default:
            return "";
          }
        }());
        ...
        dynamicCSS = (function(){
          ...
          default:
            return " <link rel=\"stylesheet\" type=\"text/css\" href=\"./" + bundleCss + alias + "\">  ";
          }
        }());
        dynamicHTML = (function(){
          ...
          default:
            return "<script type=\"text/javascript\" src=\"./" + bundleJs + alias + "\"></script>";
          }
        }());
